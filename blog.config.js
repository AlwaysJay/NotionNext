...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '出海相对论', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '关注出海与全球化的对话类中文播客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://see-the-sea.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 出海', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wewillseethesea@163.com', // 邮箱地址 例如mail@tangly1024.com
